...
<table>
<tr>
<td width="50%" align="center" valign="top"><img src="./.readme/screen/02-kpi.png" alt="Streamed answer"><br><small><b>Streamed answers</b> — markdown-rendered, token by token</small></td>
<td width="50%" align="center" valign="top"><img src="./.readme/screen/03-stat.png" alt="Provider choice"><br><small><b>Provider choice</b> — OpenAI · Gemini · Claude · custom</small></td>
</tr>
<tr>
<td width="50%" align="center" valign="top"><img src="./.readme/screen/04-gauge.png" alt="Managed tokens"><br><small><b>Managed tokens</b> — visibility per user group or user</small></td>
<td width="50%" align="center" valign="top"><img src="./.readme/screen/05-throughput.png" alt="Copy controls"><br><small><b>PRO controls</b> — stop generation, copy any bubble</small></td>
</tr>
</table>
...
| **Google Gemini** | Flash (latest) · Pro (latest) · Flash Lite (latest) · 3 Pro · 3 Flash · 3.5 Flash · 3.1 Flash Lite · 2.5 Pro · 2.5 Flash · 2.5 Flash Lite |
...
| Feature                                                       |  FREE  |  PRO   |
| ------------------------------------------------------------- | :----: | :----: |
| AI chat on the dashboard (server-proxied, key never in browser) |   ✅   |   ✅   |
| Admin-managed API tokens with visibility scopes               |   ✅   |   ✅   |
| Streamed, markdown-rendered answers (sanitized)               |   ✅   |   ✅   |
| OpenAI on the newest supported model                          |   ✅   |   ✅   |
| Send-by-Enter &amp; streaming toggles                             |   ✅   |   ✅   |
| Upgrade-safe field schema (Zabbix 6.x → 7.x)                  |   ✅   |   ✅   |
| **Provider choice — OpenAI · Gemini · Claude**                |   ❌   |   ✅   |
| **Custom OpenAI-compatible endpoint** (Ollama, vLLM, …)       |   ❌   |   ✅   |
| **Model selection** from the curated per-provider list        |   ❌   |   ✅   |
| **Tuning parameters per token** (temperature · top-p · max tokens · N) |   ❌   |   ✅   |
| **Org-wide global configuration** (one token for all widgets) |   ❌   |   ✅   |
| **Live Zabbix data through MCP tools**                            |   ❌   |   ✅   |
| **Attachments** (screenshots, logs and config files)              |   ❌   |   ✅   |
| **Remember conversation per user in the database**                |   ❌   |   ✅   |
| **Stop generation &amp; copy controls**                           |   ❌   |   ✅   |
| **Hide the initMAX logo**                                     |   ❌   |   ✅   |
...
Pick a provider in the widget settings, then one of the models below. _Custom_ accepts any OpenAI-compatible endpoint (you supply the model name)._

- **OpenAI**: GPT-5.6 Luna, GPT-5.6 Sol, GPT-5.6 Terra, GPT-5.5, GPT-5.5 Pro, GPT-5.4, GPT-5.4 Mini, GPT-5.4 Nano, GPT-5.4 Pro
- **Gemini**: Gemini Flash (latest), Gemini Pro (latest), Gemini Flash Lite (latest), Gemini 3 Pro, Gemini 3 Flash, Gemini 3.6 Flash, Gemini 3.5 Flash, Gemini 3.5 Flash Lite, Gemini 3.1 Flash Lite, Gemini 2.5 Pro
- **Claude (Anthropic)**: Claude Sonnet 5, Claude Opus 4.8, Claude Sonnet 4.6, Claude Haiku 4.5
- **Custom**: any OpenAI-compatible endpoint

Not supported (retired - rejected by the install gate): _OpenAI_: gpt-5.2-pro, gpt-5.2, gpt-5.1, gpt-5, gpt-5-mini, gpt-5-nano, gpt-5-pro, gpt-4.1, gpt-4.1-mini, gpt-4.1-nano, gpt-4o, gpt-4o-mini, gpt-4, gpt-4-turbo, gpt-3.5-turbo, o1, o1-pro, o1-mini, o3, o3-pro, o3-mini, o4-mini; _Gemini_: gemini-3.1-pro-preview, gemini-3.1-flash-lite-preview, gemini-2.5-flash, gemini-2.5-flash-lite, gemini-2.0-flash-001, gemini-2.0-flash-lite-001, gemini-2.0-flash, gemini-2.0-flash-lite, gemini-1.5-pro, gemini-1.5-flash, gemini-1.0-pro; _Claude (Anthropic)_: claude-opus-4-7, claude-opus-4-6, claude-opus-4-5-20251101, claude-opus-4-1-20250805, claude-opus-4-20250514, claude-sonnet-4-5-20250929, claude-sonnet-4-20250514, claude-haiku-4-5, claude-3-opus, claude-3-sonnet, claude-3-haiku, claude-3-5-sonnet, claude-3-5-haiku.
